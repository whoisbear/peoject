...
Route::group(['namespace'=>'Admin','prefix'=>'admin'],function(){
    ...
    Route::group(['middleware'=>'auth.admin'],function(){
        ...
        //咨询
        Route::get('article_list/{classid?}/{start_time?}/{end_time?}/{name?}','ArticleController@article_list')->name('admin.article_list');
        ...
        Route::delete('article_delete','ArticleController@article_delete')->name('admin.article_delete');
        Route::post('article_state','ArticleController@article_state')->name('admin.article_state');
        Route::any('ceshi','ArticleController@ceshi')->name('admin.ceshi');
        //广告管理
