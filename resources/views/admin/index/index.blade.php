		  ...
		  <ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="#">切换账户</a></li>
						<li><a href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">退出</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="{{route('admin.article_list')}}" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="{{route('admin.advert_list')}}" data-title="广告管理" href="javascript:void(0)">广告管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="{{route('admin.product_brand')}}" data-title="品牌管理" href="javascript:void(0)">品牌管理</a></li>
					<li><a data-href="{{route('admin.product_category')}}" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
					<li><a data-href="{{route('admin.product_list')}}" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
...
<script type="text/javascript" src="{{URL::asset('static/h-ui.admin/js/H-ui.admin.js')}}"></script> <!--/_footer 作为公共模版分离出去-->
